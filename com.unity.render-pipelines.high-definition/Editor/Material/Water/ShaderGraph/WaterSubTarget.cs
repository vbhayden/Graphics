...
namespace UnityEditor.Rendering.HighDefinition.ShaderGraph
{
    sealed partial class WaterSubTarget : LightingSubTarget, ILegacyTarget, IRequiresData<WaterData>
    {
        ...
        public static KeywordDescriptor WaterQuadGeometry = new KeywordDescriptor()
        {
            displayName = "WaterQuadGeometry",
            referenceName = "WATER_QUAD_GEOMETRY",
            type = KeywordType.Boolean,
            definition = KeywordDefinition.MultiCompile,
            scope = KeywordScope.Global,
            stages = KeywordShaderStage.Default
        ...
        public static DefineCollection WaterForwardDefines = new DefineCollection
        {
        ...
        public static PassDescriptor GenerateWaterForwardPass()
        {
            return new PassDescriptor
            {
                ...
                defines = HDShaderPasses.GenerateDefines(WaterForwardDefines, false, false),
        ...
        protected override void CollectPassKeywords(ref PassDescriptor pass)
        {
            ...
            pass.keywords.Add(WaterQuadGeometry);
            pass.keywords.Add(HasRefraction);
        }
